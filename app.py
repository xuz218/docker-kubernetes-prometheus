...
# Define your metrics
REQUESTS = Counter('total_requests', 'Total web app request count')
ERRORS = Counter('error_requests', 'Total web app error count')
...
def health():
        if crashed:
                return {"status": "error", "message": "crashed"}, 503
        return {"status": "success", "message": "Work properly"}, 200
...
def crash():
        global crashed
        crashed = True
        return {"status": "success", "message": "crashed"}, 200
